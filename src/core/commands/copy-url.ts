...
export const CopyTabURL = defineCommand(CopyTabURLFn, {}, "url", [
  "clipboardWrite",
]);
export const CopyLinkURL = defineCommand(CopyLinkURLFn, {}, "url", [
  "clipboardWrite",
]);
export const CopyImageURL = defineCommand(CopyImageURLFn, {}, "image", [
  "clipboardWrite",
]);
