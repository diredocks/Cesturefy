...
const OpenURLFromClipboardInNewPrivateWindowFn: CommandFn = async function (sender) {
  if (!sender.tab?.url) return false;
...
export const OpenURLFromClipboardInNewPrivateWindow = defineCommand(OpenURLFromClipboardInNewPrivateWindowFn, {}, 'clipboard', ['clipboardRead']);
